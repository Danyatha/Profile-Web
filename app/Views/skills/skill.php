...
<body>
    <header class="profile-header">
        ...
        <img src="<?= base_url('images/skills.webp') ?>" class="bg-profile-image" alt="bg-profile-image" loading="lazy" style="object-fit: cover;object-position: 20% 60% ;">
    ...
    <?= $this->include('skills/partials/skills.php') ?>
    <footer>
