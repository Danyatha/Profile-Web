<style>
    ...
    footer::before {
        ...
        right: 0;
        height: 1px;
        background: linear-gradient(90deg, transparent 0%, var(--color-smoke) 50%, transparent 100%);
    }
    ...
    /* Copyright or additional footer info */
    .footer-bottom {
        margin-top: 3rem;
        padding-top: 2rem;
    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-column">
                ...
                <p>
                    Got an exciting project or just want to chat about tech?
                    I'm always happy to explore new ideas and collaborations.
                </p>
